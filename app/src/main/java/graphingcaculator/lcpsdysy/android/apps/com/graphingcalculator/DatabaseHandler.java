...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public boolean create(FormulaName myObj) {
    ...
    public List<FormulaName> read(String searchTerm) {

        List<FormulaName> recordsList = new ArrayList<FormulaName>();
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                FormulaName myObject = new FormulaName(objectName);
